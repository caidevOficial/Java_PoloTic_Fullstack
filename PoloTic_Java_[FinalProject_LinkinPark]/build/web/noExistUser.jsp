	...
	<div class="row">
		...
		<div class="span12">
			...
			<div class="error-container">
				...
				<h2>Oh crap! this is embarrassing.. The user doesn't exist in the system, please choose another!.</h2>
				
				<div class="error-details">
					Sorry, an error has occurred! try to register the employee again at the <a href="registerEmployee.jsp">REGISTER page</a> !

                            ...
                            <form action="DeleteUser" method="POST">
                                ...
                                <div class="login-fields">
                                    ...
                                    <div class="field">
                                        ...
                                        <input type="text" id="employee" name="id_user" value="" placeholder="id_user" class="login" required/>
                                    </div> <!-- /field -->
                                ...
                                <div class="login-actions">
                                    ...
                                    <button class="button btn btn-primary btn-large">Delete User</button>
                                </div> <!-- .actions -->
                            </form>
                        </div> <!-- /content -->

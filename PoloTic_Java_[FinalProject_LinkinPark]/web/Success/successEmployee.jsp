            ...
            <div class="row">		
                <div class="span12">			
                    <div class="error-container">
                        ...
                        <h2>User and Employee: Action successfully!.</h2>

                        <div class="error-details">
                            Now you can go to the <a href="../login.jsp">LOGIN page</a> or perhaps try go to the <a href="../index.jsp">INDEX page</a>
